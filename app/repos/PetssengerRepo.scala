...
class PetssengerRepoImpl @Inject() (reactiveMongoApi: ReactiveMongoApi) extends PetssengerRepo {

  def collection = reactiveMongoApi.db.collection[JSONCollection]("petssengers");
